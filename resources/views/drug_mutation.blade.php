...
<table>
    <thead>
        ...
        <th  colspan='10' style="font-weight: bold;  vertical-align: center; font-size: 14px;" > Rekap Data Mutasi Obat </th>
    </thead>
</table>
<br>
<br>
<table>
    ...
    <?php $no++ ;?>
        <tr>
            ...
            <td>{{ $drug->drugname ? $drug->drugname->drug_name : 'Not Found' }}</td>
